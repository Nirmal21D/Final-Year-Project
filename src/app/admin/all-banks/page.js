...
export default function AllBankss() {
  ...
  useEffect(() => {
    const fetchBanks = async () => {
      ...
      const banksDocs = querySnapshot.docs.map((doc) => ({
        id: doc.id,
        ...doc.data(),
      }));
      setBanks(banksDocs);
  ...
  return (
    <Box display="flex" minHeight="100vh" bg="#F0F4FB" mx="auto">
      ...
      {/* Main Content */}
      <Box flex="1" p="6" mx="auto" maxW="80%" position="relative" left={140}>
        <Box
          display="flex"
          ...
          mb="6"
        >
          <Text fontSize="3xl" fontWeight="semibold" color="emerald.400">
            All Banks
          </Text>
        ...
        <Box bg="white" rounded="lg" shadow="lg" p="6">
          <Box overflowX="auto">
            <Table minW="full">
              <Thead>
                <Tr>
                  <Th px="6" py="3" textTransform="uppercase" color="gray.500">
                    Name
                  </Th>
                  <Th px="6" py="3" textTransform="uppercase" color="gray.500">
                    Email
              ...
              <Box display="grid" gridTemplateColumns="1fr 1fr" gap="4">
                <Box>
                  ...
                  <Box display="flex" alignItems="center" spaceX="2">
                    ...
                    <Text>
                      {selectedBank /* .createdAt?.toDate().toLocaleDateString() */ ||
                        "N/A"}
                    </Text>
                  </Box>
                </Box>
                        ...
                        <Box spaceY="2" fontSize="sm">
                          ...
                          >
                            <Box display="flex" spaceX="2" alignItems="center">
                              <Text>👥</Text>
                              <Text>
                                {plan.registeredUsers?.length || 0}/
                                {plan.maxParticipants} seats
                              </Text>
                            </Box>
                            <Box display="flex" spaceX="2" alignItems="center">
                              <Text>💰</Text>
                              <Text>
                                {plan.isPaid ? `${plan.amount} INR` : "Free"}
                              </Text>
                            </Box>
                          </Box>
                            ...
                            <Box display="flex" spaceX="2" alignItems="center">
                              ...
                              <Text>
                                {plan.planDates?.[0]?.startTime?.seconds
                                  ? new Date(
                                      plan.planDates[0].startTime.seconds * 1000
                                    ).toLocaleDateString()
                                  : "N/A"}
                              </Text>
                            </Box>
                          ...
                          <Box mt="4">
                            ...
                            >
                              <Text>
                                {plan.registeredUsers?.length || 0} registered
                              </Text>
                              <Text>
                                {plan.maxParticipants -
                                  (plan.registeredUsers?.length || 0)}{" "}
